...
export const configurationErrorCodes = [
  ...
  "PROMOTION_POLICY_UNKNOWN",
  "PROMOTION_POLICY_INVALID",
  "PROMOTION_POLICY_CONFLICT",
  "PROMOTION_TRANSITION_NOT_ALLOWED",
  "PROMOTION_SOURCE_NOT_FOUND",
  "PROMOTION_SOURCE_INVALID",
  "PROMOTION_SOURCE_INTEGRITY_FAILED",
  "PROMOTION_DESTINATION_INVALID",
  "PROMOTION_DESTINATION_DRIFTED",
  "PROMOTION_SCHEMA_INCOMPATIBLE",
  "PROMOTION_VALIDATION_FAILED",
  "PROMOTION_CAPABILITY_BLOCKED",
  "PROMOTION_APPROVAL_REQUIRED",
  "PROMOTION_APPROVAL_INVALID",
  "PROMOTION_PLAN_STALE",
  ...
  "ACTIVE_CONFIGURATION_INTEGRITY_FAILED",
] as const;
