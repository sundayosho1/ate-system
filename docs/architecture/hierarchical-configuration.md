...
foundations. Prompt 11 adds maker-checker approval governance. Prompt 12 adds controlled promotion
and rollback release governance. The configuration package still does not implement frontend
configuration editing, trading strategies, risk, portfolio, MT5, execution or live trading.
