...
It does not implement feature flags, maker-checker approval, promotion, environment promotion,
operational rollback, market data, risk, portfolio, MT5, execution or live trading.
